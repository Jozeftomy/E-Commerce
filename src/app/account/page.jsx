  ...
  return (
    <div className='bg-white text-black'>
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow w-full px-[5%] mt-[120px]">
          {/* Navigation */}
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            {/* Sidebar */}
            <div className="w-full lg:w-[25%] bg-white rounded-md p-[5%] font-poppins flex flex-col gap-2 shadow-md">
            ...
            {/* Form */}
            <div className="w-full lg:w-[70%] bg-white shadow-md rounded-md p-[5%] flex flex-col gap-6 font-poppins mx-auto">
